...
public enum ErrorCode {
  ...
  EMAIL_ALREADY_EXISTS_OTHER_AUTH(
      "이미 다른 방식으로 인증되어 있는 이메일입니다.", "4202_ EMAIL_ALREADY_EXISTS_OTHER_AUTH_ERROR"),
  ...
  VIRTUAL_WORKSPACE_CREATE_FAILED(
      "VirtualWorkspace 생성에 실패하였습니다", "46023_VIRTUAL_WORKSPACE_CREATE_FAILED"),
  //
