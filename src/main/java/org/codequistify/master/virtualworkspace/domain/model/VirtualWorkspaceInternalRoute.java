...
public record VirtualWorkspaceInternalRoute(String namespace, String serviceName, int servicePort) {
  ...
  public static VirtualWorkspaceInternalRoute of(
      String namespace, String serviceName, int servicePort) {
