...
public class PlayerDetailsController {
  ...
  public ResponseEntity<BasicResponse> updatePassword(
      @AuthenticationPrincipal Player player, @RequestBody UpdatePasswordRequest request) {
  ...
  @Operation(summary = "비밀번호 초기화", description = "비밀번호를 초기화합니다. password에 새로운 비밀번호를 담아 보냅니다.")
  @LogMonitoring
  @PutMapping("password")
  ...
  @Operation(summary = "계정 삭제", description = "계정을 삭제합니다. 즉시 해당 계정에 대한 데이터가 소실됩니다. 복구는 불가능합니다.")
  @LogMonitoring
  @DeleteMapping("{uid}")
  public ResponseEntity<BasicResponse> deletePlayer(
      @AuthenticationPrincipal Player player, @PathVariable String uid) {
