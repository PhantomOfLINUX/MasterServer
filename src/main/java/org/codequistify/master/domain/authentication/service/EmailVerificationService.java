...
public class EmailVerificationService {
  ...
  @Async
  @Transactional
  public void sendVerifyMail(String email, EmailVerificationType emailVerificationType)
    ...
    try {
      ...
      throw new BusinessException(
          ErrorCode.EMAIL_SENDING_FAILURE, HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  private MimeMessage createMessage(
      String toMail, Map<String, Object> variables, EmailVerificationType type)
      throws MessagingException {
  ...
  // 인증 정보 틀 저장
  @Transactional
  public EmailVerification saveEmailVerification(
      String email, String code, EmailVerificationType emailVerificationType) {
  ...
  public void updateVerification(String email, EmailVerificationType type) {
    emailVerificationRepository
        .findFirstByEmailAndUsedAndEmailVerificationTypeOrderByCreatedDateDesc(
            email, false, type) // 사용안된 인증 정보사용
  ...
  @LogMonitoring
  @Transactional
  public EmailVerification getEmailVerificationByEmail(
      String email, Boolean used, EmailVerificationType type) {
    return emailVerificationRepository
        .findFirstByEmailAndUsedAndEmailVerificationTypeOrderByCreatedDateDesc(email, used, type)
        .orElseThrow(() -> {
